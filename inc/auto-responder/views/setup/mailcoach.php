...
<div class="tvd-row">
    <div class="tvd-col tvd-s12">
        <p class="tve-mailcoach-help">
            <?php echo esc_html__( 'To get your API Key, go to your Mailcoach account, navigate to "API tokens" in the settings and create a new token with at least "view email lists" and "manage subscribers" permissions.', 'thrive-dash' ) ?>
        </p>
    </div>
</div>
<div class="tve-sp"></div>
